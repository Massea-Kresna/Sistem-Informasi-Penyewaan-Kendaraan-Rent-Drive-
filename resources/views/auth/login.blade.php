...
<head>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .panel-logo-mark svg { width: 14px; height: 14px; }
        .panel-logo-name {
            font-size: 13px;
            font-weight: 600;
        ...
        @media (min-width: 960px) { .vertical-line { display: block; } }
    </style>
</head>
<body>
    ...
    <aside class="panel-left">
        <div class="panel-logo">
            <!-- <div class="panel-logo-mark">
                <svg viewBox="0 0 24 24" fill="none" stroke="rgba(255,255,255,0.8)" stroke-width="2"><path d="M5 17H3a2 2 0 01-2-2V5a2 2 0 012-2h11a2 2 0 012 2v3"/><rect x="9" y="11" width="14" height="10" rx="2"/><circle cx="12" cy="21" r="1"/><circle cx="20" cy="21" r="1"/></svg>
            </div> -->
            <span class="panel-logo-name">Rent-Drive</span>
        </div>

        <div class="panel-body">
            <h1 class="panel-heading">
                Mulai
                <strong>perjalanan Anda</strong>
            </h1>
            <p class="panel-desc">
                Reservasi, pantau perjalanan, dan nikmati kemudahan sewa kendaraan kapan dan dimana saja
            </p>
        </div>

        <span class="panel-footer">Rent-Drive &copy; {{ date('Y') }}</span>
    </aside>
    ...
    <main class="panel-right">
        <div class="form-shell">
            ...
            <div class="mobile-logo">
                ...
                <span class="mobile-logo-name">Rent Drive</span>
            </div>
